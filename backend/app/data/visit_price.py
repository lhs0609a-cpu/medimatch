...
AVG_VISIT_PRICE: Dict[str, int] = {
    # 외래 1건당 평균 진료비 (HIRA 의원 평균, 임플란트/교정 등 고가 시술은 별도 시뮬)
    "내과":       42000,
    "이비인후과": 35000,
    "정형외과":   62000,   # 도수치료 비급여 일부 포함
    "소아청소년과": 28000,
    "피부과":     85000,   # 비급여 평균 가중 (전 시술 평균)
    "안과":       55000,   # 라식 제외 일반 외래 평균
    "산부인과":   58000,
    "치과":       72000,   # 일반 외래 (임플란트/교정은 별도 시뮬)
    "재활의학과": 62000,
    "비뇨의학과": 52000,
    "정신건강의학과": 58000,
    "성형외과":   180000,  # 외래 평균 (시술은 별도)
    "신경외과":   78000,
    "마취통증의학과": 65000,
    "흉부외과":   95000,
    "외과":       55000,
