...
const sections: FeatureSection[] = [
  {
    Mockup: ChartMockup,
    eyebrow: 'AI 음성 차트',
    title: <>진료 대화만,<br /><span className="text-primary">차트는 자동 완성</span></>,
    desc: 'CC·PI·PMH·ICD-10 진단코드까지 AI가 채웁니다. 의사는 환자만 보세요.',
  ...
  },
  {
    Mockup: ClaimsMockup,
    eyebrow: '삭감 방어',
    title: <>위험 청구를<br /><span className="text-primary">실시간으로 막아</span></>,
    desc: '과거 삭감 패턴 학습 → 위험 코드 즉시 경고 + 대안 코드 추천. 손에 들어왔어야 할 돈을 다 받습니다.',
  ...
  },
  {
    Mockup: CRMMockup,
    eyebrow: '환자 리콜 CRM',
    title: <>잊혀진 환자를<br /><span className="text-primary">자동으로 다시</span></>,
  ...
  },
  {
    ...
    eyebrow: '예약·접수',
    title: <>도착·진료중·완료<br /><span className="text-primary">한 화면에서</span></>,
  ...
  },
  {
    ...
    eyebrow: '경영 대시보드',
    title: <>매출·환자·재방문<br /><span className="text-primary">AI가 분석해 알림</span></>,
    desc: '공실 시간·미방문 환자·재고 이슈를 자동 발견. "수요일 14시 공실 38%" 같은 인사이트.',
  ...
  },
  {
    ...
    eyebrow: '약국 브릿지',
    title: <>처방전을<br /><span className="text-primary">3초 만에 약국으로</span></>,
