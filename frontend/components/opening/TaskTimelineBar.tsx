...
export default function TaskTimelineBar({ timeline }: TaskTimelineBarProps) {
  return (
    <div className="space-y-1.5">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/10 rounded-lg px-3 py-2 space-y-1.5">
        ...
        {timeline.seasonalTip && (
          <div className="flex items-start gap-1.5 pt-1 border-t border-blue-200/50 dark:border-blue-700/30">
            <Leaf className="w-3 h-3 text-blue-500 mt-0.5 flex-shrink-0" />
            <span className="text-xs text-blue-600 dark:text-blue-400">{timeline.seasonalTip}</span>
          </div>
        )}
        ...
        {timeline.regionalVariation && (
          <div className="flex items-start gap-1.5 pt-1 border-t border-blue-200/50 dark:border-blue-700/30">
            ...
            <span className="text-xs text-blue-600 dark:text-blue-400">{timeline.regionalVariation}</span>
          </div>
        )}
      </div>
    </div>
