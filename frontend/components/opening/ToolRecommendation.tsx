...
const PHASE_TOOLS: Record<number, Tool[]> = {
  1: [
    ...
    { icon: Landmark, label: '대출 계산기', description: '개원 자금 대출 시 월 상환금 계산', href: '/opening/budget?tab=loan' },
  ],
  2: [
  ...
  3: [
    { icon: FileCheck, label: '인허가 가이드', description: '개설신고·사업자등록 절차 안내', href: '/opening/permits' },
    { icon: FolderOpen, label: '서류 관리', description: '인허가 서류 진행 상황 추적', href: '/opening/permits' },
  ],
  4: [
    { icon: Paintbrush, label: '인테리어 파트너', description: '검증된 의료 전문 인테리어 업체', href: '/opening/vendors?tab=interior' },
    { icon: ShoppingCart, label: '공동구매', description: '자재 공동구매로 최대 30% 절감', href: '/emr/group-buying', highlight: true },
  ],
  5: [
    { icon: ListChecks, label: '장비 체크리스트', description: '진료과별 필수/권장 장비 목록', href: '/opening/phase/5?tab=checklist' },
  ...
  6: [
    ...
    { icon: FileText, label: '채용공고 템플릿', description: '의료기관 채용공고 양식 제공', href: '/opening/phase/6?tab=documents' },
  ],
  7: [
    { icon: TrendingUp, label: '마케팅 ROI 분석', description: '채널별 마케팅 효과 분석', href: '/emr/cost/marketing', highlight: true },
    { icon: MapPinned, label: '네이버 플레이스 가이드', description: '스마트플레이스 등록 및 최적화', href: '/opening/phase/7?tab=documents' },
    { icon: Megaphone, label: '마케팅 채널 체크리스트', description: '개원 시 활용 가능한 마케팅 채널', href: '/opening/phase/7?tab=checklist' },
  ],
  8: [
