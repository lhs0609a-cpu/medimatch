...
export default function OpeningProjectWizardPage() {
  ...
  const handleCreate = () => {
    // Save to localStorage via useOpeningProject hook (no login required)
    project.updateMeta({
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-2xl w-full space-y-6">
        ...
        <div className="flex items-center justify-between">
          <button
            onClick={() => step > 1 ? setStep(step - 1) : router.push('/opening-project')}
