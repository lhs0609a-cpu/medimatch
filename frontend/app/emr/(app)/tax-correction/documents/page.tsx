...
const statusConfig: Record<DocStatus, { label: string; color: string; bg: string }> = {
  ...
  classified: { label: 'AI 분류됨', color: 'text-blue-600', bg: 'bg-blue-100 dark:bg-blue-900/20' },
              ...
              >
                ...
                <div className="p-3 space-y-2">
                  ...
                  {doc.ai_classification && (
                    <div className="text-2xs text-blue-600 flex items-center gap-1">
            ...
            <div className="p-5 space-y-4">
              ...
              {selectedDoc.ai_classification && (
                <div className="p-3 rounded-xl bg-blue-50 dark:bg-blue-900/10">
                  ...
                  <div className="text-sm text-blue-800 dark:text-blue-300">{selectedDoc.ai_classification}</div>
                </div>
              )}
