    ...
    <div className="p-8">
      ...
      {revenue && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100">
            <div className="flex items-center gap-3 mb-2">
              <TossIcon icon={Eye} color="from-blue-500 to-blue-600" shadow="shadow-blue-500/25" size="sm" />
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100">
            <div className="flex items-center gap-3 mb-2">
              <TossIcon icon={MousePointer} color="from-blue-500 to-blue-600" shadow="shadow-blue-500/25" size="sm" />
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100">
            <div className="flex items-center gap-3 mb-2">
              <TossIcon icon={TrendingUp} color="from-blue-500 to-blue-600" shadow="shadow-blue-500/25" size="sm" />
      ...
      <div className="flex items-center gap-2 mb-6 overflow-x-auto pb-2">
        <button onClick={() => { setStatusFilter(''); setPage(1); }} className={`px-3 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${!statusFilter ? 'bg-blue-600 text-white' : 'bg-white border border-gray-200 text-gray-600 hover:border-gray-300'}`}>
          전체
        </button>
        {ALL_STATUSES.map((s) => {
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[85vh] overflow-y-auto m-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                <div className="text-center p-3 bg-blue-50 rounded-xl">
                  <p className="text-xl font-bold text-blue-700">{detailModal.clicks.toLocaleString()}</p>
                  <p className="text-xs text-blue-600">클릭</p>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                  <div className="h-full bg-blue-500 rounded-full" style={{ width: `${detailModal.budget > 0 ? Math.min((detailModal.spent / detailModal.budget) * 100, 100) : 0}%` }} />
                </div>
