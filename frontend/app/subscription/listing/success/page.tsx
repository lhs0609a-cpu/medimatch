...
import { CheckCircle2, Building2, Loader2, AlertTriangle, RefreshCw } from 'lucide-react';
...
function SuccessContent() {
  ...
  const activateSubscription = async () => {
    try {
      setStatus('loading');
      const data = await listingSubscriptionService.activate({
        auth_key: authKey!,
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">구독이 시작되었습니다!</h1>
          <p className="text-gray-600 mb-6">
            매물 등록 크레딧 {result?.total_credits || 1}개가 부여되었습니다.
          </p>
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6 text-left">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium">{result.remaining_credits}개</div>
                </div>
                <div>
...
export default function ListingSubscriptionSuccessPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
