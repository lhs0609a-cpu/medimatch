...
import { CheckCircle2, Cog, Loader2, AlertTriangle, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">프로그램 개발 구독이 시작되었습니다!</h1>
          <p className="text-gray-600 mb-6">
            24시간 내에 담당자가 연락드려 업무 분석을 시작합니다.
          </p>
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6 text-left">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium">₩{(result.monthly_amount || 300000).toLocaleString()}</div>
                </div>
                <div>
...
export default function ProgramSubscriptionSuccessPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
