...
import { CheckCircle2, Globe, Loader2, AlertTriangle, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">홈페이지 제작 구독이 시작되었습니다!</h1>
          <p className="text-gray-600 mb-6">
            전담팀이 배정되어 곧 제작을 시작합니다.
          </p>
...
export default function HomepageSubscriptionSuccessPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
